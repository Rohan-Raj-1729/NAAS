...
class ManagerWindow:
    ...
    def editCustomer(self):
        ...
        self.labelUser = Label(self.editFrame, text="Customer ID   ", font=('arial', 12, 'bold'), bg="SkyBlue2", bd=20)
    ...
    def addDeliverer(self):
        ...
        self.btnAdd = Button(self.frameDetails, text="Add", font=('arial', 12, 'bold'), width=10, command=lambda: self.addDelDet())
...
class DelivererWindow:
    def __init__(self, master, deliverer):
        ...
        self.labelTFare = Label(self.frame1, text="Wages", font=('arial', 10, 'bold'), bg="Skyblue2",
                                   bd=20)
        ...
        for i in deliverer.Customers:
            ...
            for j in i.subscriptions :
                ...
                self.labelWage = Label(self.frame1, text=str(j.publication.price*0.025), font=('arial', 10, 'bold'),
                                              bg="Skyblue2", bd=20)
                self.labelWage.grid(row=k + 1, column=6, padx=10)
                totalCost+=(j.publication.price*0.025)
                k=k+1

        self.labelTotal = Label(self.frame1, text="Total Wage :", font=('arial', 10, 'bold'),
                               bg="Skyblue2", bd=20)
        self.labelTotal.grid(row=k + 1, column=5, padx=10)


        self.labelTotalWage = Label(self.frame1, text=str(totalCost), font=('arial', 10, 'bold'),
                               bg="Skyblue2", bd=20)
